...
fn map_terminal_event(event: CrosstermEvent) -> Option<LoopEvent> {
    match event {
        CrosstermEvent::Key(KeyEvent {
            ...
            (KeyCode::F(2), _) => Some(LoopEvent::SwitchScreen(Screen::Sessions)),
            (KeyCode::F(3), _) => Some(LoopEvent::SwitchScreen(Screen::Approvals)),
            (KeyCode::F(4), _) => Some(LoopEvent::SwitchScreen(Screen::TraceArtifacts)),
            (KeyCode::F(5), _) => Some(LoopEvent::SwitchScreen(Screen::Settings)),
